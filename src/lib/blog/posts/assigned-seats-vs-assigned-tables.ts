...
export const post: BlogPost = {
  slug: "assigned-seats-vs-assigned-tables",
  title: "Assigned Seats vs. Assigned Tables at Your Wedding: Which Do You Need?",
  metaTitle: "Assigned Seats vs. Assigned Tables at a Wedding",
  metaDescription: "Do you assign seats at a wedding, or just tables? Here's when open seating works, when it fails, what caterers require, and what you'll need to print.",
  publishDate: "2026-06-10",
  category: "Guide",
  tags: ["assigned seats vs assigned tables wedding", "do you assign seats at a wedding", "open seating wedding", "wedding seating chart vs place cards"],
  readTime: 8,
  excerpt: "Open seating, assigned tables, or assigned seats — three options, and the internet won't give you a straight answer about which one you need. Here's the honest breakdown, including what your caterer will quietly require and what you'll actually have to print.",
  content: `
...
[Wedding Seater](https://weddingseater.app) handles both modes. Drag guests onto tables for the assigned-tables approach, or onto specific seats when the caterer needs a name at every chair — and switch between them without redoing your work. Flag the pairs who must sit together and the pairs who can't, and the tool enforces it even when auto-assigning everyone else. When you're done, it prints the lot: the seating chart display, the alphabetical index, per-table cards, and folded place cards with meal choices on them.

It's £10, once — not a subscription that outlives your engagement. Try the [live demo](https://weddingseater.app/demo) with a sample guest list, or [start your own chart](https://weddingseater.app) and share the link with whoever's helping.
`,
  faq: [
    {
      q: "Do you have to assign seats at a wedding?",
      a: "No, but you usually need to assign tables. For any seated dinner over about 50 guests, assigned tables prevent the scramble of couples hunting for adjacent chairs. Assigned seats (a specific chair per guest) are only necessary for formal receptions or plated dinners with meal choices.",
    },
    {
      q: "Is open seating at a wedding rude?",
      a: "Not rude, but often inconsiderate at scale. For a cocktail-style reception or a wedding under 50 guests it reads as relaxed. For a 120-person plated dinner it transfers the seating problem to your guests in real time — late arrivals get split up and the last table fills with strangers.",
    },
    {
      q: "Do I need place cards if I offer meal choices?",
      a: "In practice, yes. Catering staff deliver pre-chosen plates by reading a meal indicator on each guest's place card. Without assigned seats and marked cards, servers have to ask every guest what they ordered, which dramatically slows service. Confirm with your caterer before deciding.",
    },
    {
      q: "What's the difference between escort cards and place cards?",
      a: "Escort cards sit on a table near the entrance and tell each guest which table they're at — they 'escort' you to your table. Place cards sit at each chair and mark your exact seat. Assigned tables need escort cards or a seating chart display; assigned seats need place cards too.",
    },
    {
      q: "Can I assign tables for most guests but seats for some?",
      a: "Yes, and it's a common compromise. Assign specific seats at the head table and the parents' tables — where adjacency carries meaning — and assign only tables everywhere else. You get precision where it matters without choreographing every chair in the room.",
    },
  ],
};
