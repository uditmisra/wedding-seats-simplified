...
export const post: BlogPost = {
  slug: "how-to-display-wedding-seating-chart",
  title: "How to Display Your Wedding Seating Chart: Signs, Sizes, and Setup",
  metaTitle: "How to Display a Wedding Seating Chart — Signs, Sizes, Setup",
  metaDescription: "Where to put your seating chart sign, what size it needs to be, and how to format it so 140 guests can find their table without a queue. Practical, not Pinterest.",
  publishDate: "2026-05-04",
  category: "Setup",
  tags: ["wedding seating chart sign", "how to display seating chart", "seating chart size", "wedding seating chart display"],
  readTime: 7,
  excerpt: "Your seating chart is finished. Now where does it go, how big should it be, and how do you stop 140 guests from forming a single-file queue to read it? Here's the practical setup guide nobody publishes.",
  content: `
...
`,
  faq: [
    {
      q: "How big should a wedding seating chart sign be?",
      a: "Minimum 18×24\" for up to 100 guests, 24×36\" for 100–150, 30×40\" for 150–200. Past 150 guests, split into two signs (A–M, N–Z) to avoid bottlenecks. Names should be at least 24pt, table numbers at 30pt+.",
    },
    {
      q: "Where should I put the seating chart at the reception?",
      a: "15 feet inside the reception room, not at the doorway. Use an easel at eye level (around 5'6\" to center). Light it if the venue is dim. A freestanding location with 360° access is better than wall-mounted, since guests can approach from multiple directions.",
    },
    {
      q: "Should I sort the seating chart alphabetically or by table?",
      a: "Alphabetically by last name. Guests know their own name; they don't know their table. Sort-by-table only works if you've told guests their table number in advance (rare). Last-name alphabetical with table numbers right-aligned is the fastest format to scan.",
    },
    {
      q: "Do I need both a seating chart sign and place cards?",
      a: "The sign tells guests their table; place cards tell them their seat. For most weddings, both make sense — the sign at the entrance, place cards at each setting. Escort cards (individual cards at the entrance) can replace the sign for a more formal look, but only under ~120 guests.",
    },
    {
      q: "What's the best way to print a wedding seating chart sign?",
      a: "Export the alphabetical index PDF from your seating planner, send it to a local print shop, and have it mounted on rigid foam-core or signboard. Costs $40–80 depending on size. Wedding Seater exports a print-ready version sized for 18×24\" or 24×36\" sign printing.",
    },
  ],
};